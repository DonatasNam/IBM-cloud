              ...
              struct blob_attr *msg)
{
    ...
    /*
        In this example, if a specific program number is requested, the program name is returned.
        If the requesting program number is 0, return all programs list.
    */
...
static int display_ubus_init(const char *path)
{
    ...
    /*  Registration objects and methods to UBUSD for other UBUS clients. */
